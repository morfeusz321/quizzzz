...
class QuestionTest {
    ...
    public void setup() {
        ...
        this.estimationQuestion = new EstimationQuestion(activity1, List.of("0", "200", "20"));
    ...
    void testDisplayQuestion() {
        ...
        Question estimationQuestion = new EstimationQuestion(activityNamed, List.of("0", "200", "20"));
    ...
    void testEqualsSame() {
        ...
        Question estimationQuestion2 = new EstimationQuestion(activity1, List.of("0", "200", "20"));
    ...
    void testEqualsNewActivities() {
        ...
        comparisonQuestion2.questionId = comparisonQuestion.questionId;
        Question estimationQuestion2 = new EstimationQuestion(activity12, List.of("0", "200", "20"));
        estimationQuestion2.questionId = estimationQuestion.questionId;
    ...
    void testNotEquals() {
        ...
        Question estimationQuestion2 = new EstimationQuestion(activity2, List.of("0", "200", "20"));
    ...
    void testHashNotEqualsActivity() {
        Question generalQuestion2 = new GeneralQuestion(activity2, List.of("5 Wh", "10 Wh", "200 Wh"), 3);
        Question comparisonQuestion2 = new ComparisonQuestion(activity2, List.of(activity1, activity3, activity4), 3);
        Question estimationQuestion2 = new EstimationQuestion(activity3, List.of("0", "200", "20"));
        Question whichIsMoreQuestion2 = new WhichIsMoreQuestion(List.of(activity4,activity2,activity3),1);
